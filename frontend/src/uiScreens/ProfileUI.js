...
import { userDetailsAction, userUpdateAction } from "../actions/userActions.js";
import { Msg } from "./../components/Msg.js";
import { myOrdersAction } from "../actions/orderActions.js";
...
const ProfileUI = () => {
  ...
  const { isloading: isLoadingOrders, error: errorOrders, orders } = myOrders;
